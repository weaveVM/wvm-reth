...
use reth_chainspec::{ChainSpec, EthereumHardfork, get_latest_gas_fee, MIN_TRANSACTION_GAS};
...
impl TestBlockBuilder {
    ...
    pub fn single_tx_cost() -> U256 {
        U256::from(EIP1559_INITIAL_BASE_FEE * get_latest_gas_fee())
    }
    ...
    pub fn generate_random_block(
        ...
        let header = Header {
            number,
            parent_hash,
            gas_used: transactions.len() as u64 * get_latest_gas_fee(),
