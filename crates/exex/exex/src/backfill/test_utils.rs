...
use eyre::OptionExt;
use reth_chainspec::{ChainSpec, ChainSpecBuilder, EthereumHardfork, MAINNET, MIN_TRANSACTION_GAS, get_latest_gas_fee};
...
fn blocks(
    ...
    let block1 = Block {
        header: Header {
            ...
            number: 1,
            gas_limit: get_latest_gas_fee(),
            gas_used: get_latest_gas_fee(),
            ..Default::default()
        },
