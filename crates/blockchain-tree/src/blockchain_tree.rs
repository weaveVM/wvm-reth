...
mod tests {
    ...
    use reth_chainspec::{ChainSpecBuilder, get_latest_gas_fee, MAINNET, MIN_TRANSACTION_GAS};
    ...
    fn consecutive_reorgs() {
        ...
        let single_tx_cost = U256::from(EIP1559_INITIAL_BASE_FEE * get_latest_gas_fee());
        let mock_tx = |nonce: u64| -> TransactionSignedEcRecovered {
            TransactionSigned::from_transaction_and_signature(
                Transaction::Eip1559(TxEip1559 {
                    chain_id: chain_spec.chain.id(),
                    nonce,
                    gas_limit: get_latest_gas_fee() as u128,
            ...
            let receipts = body
                ...
                .map(|(idx, tx)| {
                    Receipt {
                        tx_type: tx.tx_type(),
                        success: true,
                        cumulative_gas_used: (idx as u64 + 1) * get_latest_gas_fee(),
                        ..Default::default()
                    }
                    .with_bloom()
                })
            ...
            SealedBlockWithSenders::new(
                SealedBlock {
                    header: Header {
                        ...
                        gas_used: body.len() as u64 * get_latest_gas_fee(),
